...
namespace Greenery.MessageQueueMiddleware
{
    public interface IMQMStorage
    {
        ...
        IEnumerable<ClientIndetity> FindSubscribers(Guid agentId, string[] descriptions, bool IngoreFilterMode = false);
        ...
        bool HasSubscribers(Guid agentId, string[] descriptions, bool IngoreFilterMode = false);
