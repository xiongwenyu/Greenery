...
using System.Text;
using Greenery.SocketClient.Protocol.Extensions;
using System.IO;
...
namespace Greenery.SocketClient.Protocol
{
    public class SocketClient : EasyClient
    {
        public SocketClient(IRouteProvider routeProvider)
        {
            ...
            commandAssemblies.AddRange(AppDomain.CurrentDomain.GetAssemblies());
        ...
        public void SendObjectToJsonStream(byte[] route, object obj, JsonSerializerSettings settings = null)
        {
            if (obj == null)
                throw new ArgumentNullException("发送内容不能为null！");
            if (settings == null)
        ...
        public SockectPackageMessage SendObjectToJsonStreamWithResponse(byte[] route, object obj, JsonSerializerSettings settings = null)
        {
            if (obj == null)
                throw new ArgumentNullException("发送内容不能为null！");
            if (settings == null)
